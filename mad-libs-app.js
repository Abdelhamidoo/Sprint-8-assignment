...
//The original story
let originalStory = `<h2>One day I was walking through ${userInputs[0]} when I stumbled across ${userInputs[1]}. 
...
did you learn all these coping strategies?" To which I replied, "From the ${userInputs[11]} team at ${userInputs[12]}".<h2>`;
